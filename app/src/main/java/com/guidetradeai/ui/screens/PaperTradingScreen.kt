...
fun PaperTradingScreen(navController: NavHostController) {
    val viewModel: PaperTradingViewModel = androidx.lifecycle.viewmodel.compose.viewModel()
    ...
    Column(
        ...
        when (uiState) {
            is com.guidetradeai.viewmodel.PaperTradingUiState.Loading -> {
                LoadingState(modifier = Modifier.fillMaxSize())
            }
            is com.guidetradeai.viewmodel.PaperTradingUiState.Error -> {
                ErrorState(
            ...
            is com.guidetradeai.viewmodel.PaperTradingUiState.Success -> {
                ...
                Row(
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Text("${positions.size}", fontWeight = FontWeight.Bold, fontSize = 18.sp, color = androidx.compose.material3.MaterialTheme.colorScheme.onBackground)
                    }
                    Column(modifier = Modifier.weight(1f)) {
